use crate::app::Mode;
use crate::status_manager::{StatusManager, MessageType};
...
impl UIState {
    ...
    pub fn toggle_help(&mut self) {
        ...
        self.mode = if self.show_help { Mode::Help } else { Mode::Normal };
    }
    ...
    pub fn enter_insert_mode(&mut self) {
        ...
        self.status_manager.set_mode_message("-- INSERT --".to_string());
    ...
    pub fn enter_visual_mode(&mut self) {
        ...
        self.status_manager.set_mode_message("-- VISUAL --".to_string());
        self.status_message = "-- VISUAL --".to_string();
    }
    
    pub fn enter_visual_block_mode(&mut self) {
        self.mode = Mode::VisualBlock;
        self.status_manager.set_mode_message("-- VISUAL BLOCK --".to_string());
        self.status_message = "-- VISUAL BLOCK --".to_string();
    }
    
    pub fn enter_replace_mode(&mut self) {
        self.mode = Mode::Replace;
        self.status_manager.set_mode_message("-- REPLACE --".to_string());
    ...
    pub fn set_permanent_message(&mut self, message: String, message_type: MessageType) {
        self.status_message = message.clone();
        self.status_manager.set_permanent(message, message_type);
    }
    ...
    pub fn set_timed_message(&mut self, message: String, seconds: u64) {
        use crate::status_manager::MessageType;
        use std::time::Duration;
        
        let duration = Duration::from_secs(seconds);
        self.status_manager.current_message = Some(
            crate::status_manager::StatusMessage::with_duration(
                message.clone(), 
                MessageType::Info, 
                duration
            )
    ...
    pub fn set_permanent_warning(&mut self, message: String) {
        use crate::status_manager::MessageType;
        
        self.status_manager.set_permanent(message.clone(), MessageType::Warning);
        self.status_message = message;
    }
    ...
    pub fn get_command_suggestions(&self, prefix: &str) -> Vec<String> {
        ...
        // Built-in commands
        let commands = vec![
            "w", "q", "wq", "q!", "e", "help", "set", "vsplit", "split",
            "tabnew", "tabnext", "tabprev", "buffer", "bnext", "bprev"
        ];
